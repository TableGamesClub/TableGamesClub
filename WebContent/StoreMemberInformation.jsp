...
<div style="margin:0 auto;width:1300px;　">
  ...
  <div class="smbodyright">
    <div class="smbodyrighttop">
      <center><div class="aditheadimage"><img src="${pageContext.servletContext.contextPath}/controller/GetImages?id=${storemem.storeMemberId}&type=storeMember" class="headimage" style="border-radius:10px 10px 10px 10px"></div></center>
      <center><div class="adtnickaccount">
        <center><p class="font-size1">帳號:${storemem.storeUsername}</p> </center>
      </div></center>
      <center><div class="adtnickaccount">
        <center><p class="font-size1">店家手機:${storemem.storePhone}</p></center>
      </div></center>
      <center><div class="adtnickaccount">
        <center><p class="font-size1">E-mail:${storemem.storeEmail}</p></center>
      </div></center>
            <center><div class="adtnickaccount">
        <center><p class="font-size1">網址:${storemem.storeWebsite}</p></center>
      </div></center>
