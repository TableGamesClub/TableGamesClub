...
.groupinfo
{
    ...
    box-shadow: 7px 7px 7px rgba(255,255,255,0.5);
}
.gione{margin-top: 25px;margin-left: 130px;}
.gitwo{margin-top: 25px;margin-left: 130px;}
.githree{float: right;margin-right: 130px;margin-top: -50px;}
.gifour{margin-top: 25px;margin-left: 130px;}
.gifive{float: right;margin-right: 130px;margin-top: -50px;}
.gisix{margin-top: 25px;margin-left: 130px;}
.giseven{float: right;margin-right: 130px;margin-top: -50px;}
.gieight{margin-top: 25px;margin-left: 130px;}
.ginine{float: right;margin-right: 130px;margin-top: -50px;}
.giten{margin-top: 25px;margin-left: 130px;}
.gieleven{float: right;margin-right: 130px;margin-top: -50px;}
.gitwelve{margin-top: 25px;margin-left: 130px;}
</style>
...
<div style="margin:0 auto;width:1000px;">
  <div class="groupintromain">
    ...
    <div class="groupinfo gione"><p style="font-size:20px;">房間名稱:來玩桌遊巴!</p></div>
    <div class="groupinfo gitwo"><p style="font-size:20px;">店家名</p></div>
    <div class="groupinfo githree"><p style="font-size:20px;">開團者暱稱</p></div>
    <div class="groupinfo gifour"><p style="font-size:20px;">類型名</p></div>
    <div class="groupinfo gifive"><p style="font-size:20px;">桌遊名</p></div>
    <div class="groupinfo gisix"><p style="font-size:20px;">開團開始時間</p></div>
    <div class="groupinfo giseven"><p style="font-size:20px;">開團結束時間</p></div>
    <div class="groupinfo gieight"><p style="font-size:20px;">遊玩人數 </p></div>
    <div class="groupinfo ginine"><p style="font-size:20px;">店家上限人數</p></div>
    <div class="groupinfo giten"><p style="font-size:20px;">預約場地開始時間</p></div>
    <div class="groupinfo gieleven"><p style="font-size:20px;">預約場地結束時間</p></div>
    <div class="groupinfo gitwelve"><p style="font-size:20px;">遊玩時間</p></div>
  </div>
</div>
</body>
</html>