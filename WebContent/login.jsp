...
<body>
  ...
  <ul id="menu">
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-2">一般會員登入</a></li>
			<li><a href="#tabs-3">店家會員登入</a></li>
		</ul>
		<div id="tabs-2">
			<form action="<c:url value='LoginMemberServlet.do' />"
				id="loginFormMain" method="post" novalidate="">
				<input type="hidden" name="data[User][action]" value="globalLogin">
				<input type="hidden" name="data[User][type]" value="virb">
				<fieldset>
					<label>一般會員帳號:</label>
					<div class="input-container">
						<input id="dataUserEmail" type="email" name="loginId" tabindex="1"><Font
							color='red' size="-1">${ErrorMsgKey.AccountEmptyError}</Font>
						</ul>
					</div>
				</fieldset>
				...
				<fieldset>
					<div id="form_submit">
						<div class="button-wrapper">
							<input type="submit" id="main-submit" value="Log In"
								class="button large special logging-in">
							<!--                              <img class="spinner" src="https://virb.com/_assets/_images/_public/loading.png"> -->
							<div class="icon-btn check" href="#">
		...
		<div id="tabs-3">
			<form action="<c:url value='StoreMemberLoginServlet.do' />"
				id="loginFormMain" method="post" novalidate="">
				<input type="hidden" name="data[User][action]" value="globalLogin">
				<input type="hidden" name="data[User][type]" value="virb">
				<fieldset>
					<label>店家會員帳號:</label>
					<div class="input-container">
						<input id="dataUserEmail" type="email" name="storename"
							tabindex="1" autocomplete="off" data-parsley-trigger="change"
							data-parsley-required-message="Required"
							data-parsley-error-message="Invalid email" required=""
							data-parsley-id="2584">
						<ul class="parsley-errors-list" id="parsley-id-2584"></ul>
					</div>
				</fieldset>
				<fieldset class="password">
					<label>店家會員密碼:</label>
					<div class="input-container">
						<input id="dataUserPassword" type="password" name="storepassword"
							tabindex="2" value="" autocomplete="off"
							data-parsley-trigger="change"
							data-parsley-required-message="Required" required=""
							data-parsley-id="4824">
						<ul class="parsley-errors-list" id="parsley-id-4824"></ul>
						${ErrorMsgKey.AccountError} ${ErrorMsgKey.Passwordrror}
					</div>
				</fieldset>
				<fieldset>
					<div id="form_submit">
