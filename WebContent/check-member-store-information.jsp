...
<div id="HEADERONE"></div>
  ...
  <br>
  <div class="toggler" style="margin:0 auto;width:978px;height:800px;display:none"  id="gamesDemo">
  <div id="effect" class="ui-widget-content ui-corner-all" style="margin:0 auto;width:870px;height:800px;
      background: -webkit-gradient(linear, left top, right bottom, color-stop(0%,#ffffff), color-stop(100%,#ced3e8));
      box-shadow: 3px 3px 3px rgba(117,34,1,0.4);  
      border-radius:10px 10px 10px 10px;">
