...
//                     icon: createMarkerIcon(address.StroeName),
    ...
    function attachSecretMessage(marker, num ,value) {
    	...
    	var vv = '<div id="content" style="width:500px;height:500px">'+
        '<h4 id="firstHeading"><b style="color:#0055BC; font-size:16px">'+value.StroeName+'</b></h4>'+
        '<div id="bodyContent">'+
//         '<p>'+value.companyName+'</p>'+
//         '<p style="color:#C29551">'+value.wrorkDetailed+'</p>'+
        '<img src="${pageContext.servletContext.contextPath}/controller/GetImages?id='+value.StoreId+'&type=STORES" width="250px">'+
