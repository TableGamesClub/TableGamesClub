...
<link rel="stylesheet" href="/WebContent/Jquary/demo.css" type="text/css" media="screen" />
<link rel="stylesheet" href="/WebContent/Jquary/flexslider.css" type="text/css" media="screen" />
...
body
{
    background-image:url(/TGC_Hibernate_Spring_Jsp_2015_01_12_21_20/WebContent/images/scapes2.png);
...
#HEADERONE 
{
	...
	width:1300px;
	height:75px;
 	background-image:url(WebContent/res/bo.jpg); 
 	margin-bottom: 10px;
}
