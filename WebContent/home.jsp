...
.advshowright {
	...
	width: 200px;
	height: 40px;
	background: -webkit-gradient(linear, left bottom, right top, color-stop(0%, #b4ddb4),
		color-stop(0%, #83c783), color-stop(0%, #52b152),
		color-stop(67%, #008a00), color-stop(83%, #005700),
		color-stop(100%, #002400));
}
...
<script type="text/javascript">
	...
	$(function() {
		...
		// 設定跑馬燈移動的速度及輪播的速度
		var $marqueeUl = $('div#abgne_marqueeleft ul'), $marqueeli = $marqueeUl
				.append($marqueeUl.html()).children(), _height = $(
				'div#abgne_marqueeleft').height()
	...
	$(function() {
		...
		// 再來取得 div#abgne_marquee 的高來決定每次跑馬燈移動的距離
		// 設定跑馬燈移動的速度及輪播的速度
		var $marqueeUl = $('div#abgne_marqueeright ul'), $marqueeli = $marqueeUl
				.append($marqueeUl.html()).children(), _height = $(
				'div#abgne_marqueeright').height()
				* -1, scrollSpeed = 600, timer, speed = 3000 + scrollSpeed, direction = 0, // 0 表示往上, 1 表示往下
		_lock = false;
	...
	<div>
		<ul id="menu">
			...
			<li class="User"><c:if test="${empty Member}">
					...
					<ul>
						<li><a href="<c:url value='/MemberInfoServlet'/> " id="a2">會員資料</a>
	...
	<div style="margin: 0 auto; width: 1300px;">
		<div class="bodytwo">
			<div class="advshowleft">
				<center>
					<p class="advshowtext">系統公告</p>
				</center>
			</div>
			<div class="advbodyleft">
				<div id="abgne_marqueeleft">
					<div class="marquee_btn" id="marquee_next_btn">
						<img src="images/marquee_next_btn.jpg" />
					</div>
					<ul>
						<li><a
							href="http://www.flycan.com.tw/course/course_javascript.php">【快訊】12/10
								系統開始設計中 敬請見諒</a></li>
						<li><a
							href="http://www.flycan.com.tw/course/course_photopro.php">【快訊】12/31
								祝各位新年快樂~~~</a></li>
						<li><a
							href="http://abgne.tw/site-proclamation/questionnaire-1.html">【調查】桌遊排名由你來決定
								- 活動獎品大調查</a></li>
						<li><a href="http://www.ruten.com.tw/">【快訊】網站測試連線中</a></li>
					</ul>
					<div class="marquee_btn" id="marquee_prev_btn">
						<img src="images/marquee_prev_btn.jpg" />
					</div>
				</div>
			</div>
			<div class="advshowright">
				<center>
					<p class="advshowtext">店家公告</p>
				</center>
			</div>
			<div id="abgne_marqueeright">
				...
				<ul>
					<li><a
						href="http://www.flycan.com.tw/course/course_javascript.php">【開團資訊】目前已有五店家加入這個大家庭，敬請期待！</a></li>
					<li><a
						href="http://www.flycan.com.tw/course/course_photopro.php">【店家活動公告】馬來貘LINE貼圖已上架</a></li>
					<li><a
						href="http://abgne.tw/site-proclamation/questionnaire-1.html">【開團資訊】龍與地下城
							8人團 來參考看看喔!</a></li>
					<li><a href="http://www.ruten.com.tw/">【店家活動公告】益智遊戲專賣店(汐止店)
							過新春 拿好禮 現在在本店開團即可抽大獎!</a></li>
				</ul>
				<div class="marquee_btn" id="marquee_prev_btn">
					<img src="images/marquee_prev_btn.jpg" />
				</div>
